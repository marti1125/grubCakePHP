<div id="content" class="xfluid">
    ...
    <div class="portlet x9">
        ...
        <div class="portlet-header"><h4>Actualizar Filtro</h4></div>
        <?php echo $this->Session->flash(); ?>
        <div class="portlet-content">

            <?php
            echo $this->Form->create('FilterRule', array('class' => 'formulario'), array('action' => 'edit'));
            ...
            echo $this->Form->submit('Actualizar Filtro', array('class' => 'btn'));            
            ?>
