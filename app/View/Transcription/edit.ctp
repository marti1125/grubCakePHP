<div id="content" class="xfluid">
    ...
    <div class="portlet x9">
        ...
        <div class="portlet-header"><h4>Acutalizar Transcripción</h4></div>
        <?php echo $this->Session->flash(); ?>
        <div class="portlet-content">

            <?php
            echo $this->Form->create('Transcription', array('class' => 'formulario'), array('action' => 'edit'));   
            ...
            echo $this->Form->submit('Acutalizar Transcripción', array('class' => 'btn'));            
            ?>
