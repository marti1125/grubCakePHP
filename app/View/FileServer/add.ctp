<div id="content" class="xfluid">
    ...
    <div class="portlet x9">
        ...
        <div class="portlet-header"><h4>Agregar File Server</h4></div>
        <?php echo $this->Session->flash(); ?>
        <div class="portlet-content">

            <?php
            echo $this->Form->create('FileServer', array('class' => 'formulario'));            
            ...
            echo $this->Form->submit('Guardar File Server', array('class' => 'btn'));
            ?>
