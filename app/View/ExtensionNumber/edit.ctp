<div id="content" class="xfluid">
    ...
    <div class="portlet x9">
        ...
        <div class="portlet-header"><h4>Actualizar Extesión</h4></div>
        <?php echo $this->Session->flash(); ?>
        <div class="portlet-content">

            <?php
            echo $this->Form->create('ExtensionNumber', array('class' => 'formulario'), array('action' => 'edit'));            
            ...
            echo $this->Form->submit('Actualizar Extesión', array('class' => 'btn'));
            ?>
